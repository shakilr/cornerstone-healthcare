    ...
    proto: {
      initZoom: function initZoom() {
        var e,
          ...
          a = m.st.zoom,
          s = ".zoom";
        a.enabled && m.supportsTransition && (t = a.duration, n = function n(e) {
    ...
    H = (c.magnificPopup.registerModule(L, {
      ...
      proto: {
        ...
        updateGalleryButtons: function updateGalleryButtons() {
          m.st.gallery.loop || "object" != _typeof(m.arrowPrev) || null === m.arrowPrev || (0 === m.index ? m.arrowPrev.hide() : m.arrowPrev.show(), m.index === m.items.length - 1 ? m.arrowNext.hide() : m.arrowNext.show());
        }
      }
    }), "retina");
